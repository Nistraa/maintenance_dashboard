...
'''
Test class for MachineLearningService
'''
class TestTrainMachineLearningService(unittest.TestCase):
    '''
    ...
    def setUp(self):
        ...
        self.model_service = MachineLearningService(samples=self.samples, features=self.features, test_size=0.2, random_state=42)
        self.models = ['log_reg', 'decision_tree', 'svc', 'naive_bayes', 'knn']
